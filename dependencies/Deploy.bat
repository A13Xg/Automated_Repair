...
set "App[3]=Operating System Repair (Fully Automated)"
...
if "%App%" EQU "Operating System Repair" start cmd /K "color C1 & title Operating System Repair - Working & chkdsk /f C: & echo Disk Check Complete! & PAUSE & sfc /scannow & echo Continue and run DISM? & PAUSE & DISM /Online /Cleanup-Image /RestoreHealth & color C2 & echo OPERATION COMPLETED SUCCESSFULLY & title Operating System Repair - COMPLETE"
if "%App%" EQU "Operating System Repair (Fully Automated)" start cmd /K "color F1 & title Operating System Repair (Automated) - Working & chkdsk /f C: & DISM /Online /Cleanup-Image /RestoreHealth & sfc /scannow & color F2 & echo OPERATION COMPLETED SUCCESSFULLY & title Operating System Repair (Automated) - COMPLETE"
...
start cmd /K "color F1 & title Operating System Repair (Automated) - Working & DISM /Online /Cleanup-Image /RestoreHealth & sfc /scannow & color F2 & echo OPERATION COMPLETED SUCCESSFULLY & title Operating System Repair (Automated) - COMPLETE"
start sigverif
